"""
GlobalPTT v2.2 — Push-to-Talk for Windows 11
...
# layout
COL_W=300; ADD_BAR_W=50; MIN_W=440; MIN_H=320
...
class Channel:
    def __init__(self, state, index, bridge):
        ...
        self.on_status_change=None   # set by ChannelWidget after build
...
class ChannelWidget:
    ...
    def build(self, parent):
        ...
        self._combo=ttk.Combobox(b, state="readonly", font=("Segoe UI",9), height=20)
...
class App:
    ...
    def _build_ui(self):
        ...
        sb=ttk.Scrollbar(bottom, orient="horizontal", command=self._canvas.xview)
        sb.pack(side="right", fill="x", expand=True)
        self._canvas.configure(xscrollcommand=sb.set); self._canvas.pack(side="top", fill="both", expand=True)
